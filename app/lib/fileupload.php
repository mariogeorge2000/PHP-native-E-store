...
class FileUpload
{
    ...
    private function name()
    {
        ...
        $name = substr(strtolower(base64_encode($this->name . APP_SALT)), 0, 30);//3amalna kda 3ashan 3ayzeen 30 character bs msh aktr
    ...
    {
        preg_match_all('/(\d+)([MG])$/i', MAX_FILE_SIZE_ALLOWED, $matches); //bnshof el size bta3 el file b el mega wala G
